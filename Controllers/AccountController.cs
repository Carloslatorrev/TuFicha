...
namespace TuFicha.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            ViewBag.IdCiudad = new SelectList((from p in ciudades.ToList()
                                                     select new
                                                     {
                                                         IdCiudad = p.IdCiudad,
                                                          Ciu_Nombre= p.Ciu_Nombre
                                                     }),
                                                   "IdCiudad",
                                                   "Ciu_Nombre", -1);
            return View();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email,
                    ...
                    Nombre = model.Nombre, Apellidos = model.Apellidos, IdCiudad = model.IdCiudad, Genero = model.Genero, Rut = model.Rut };
        ...
        [HttpPost]
        public async Task<ActionResult> EditProfile([Bind(Include = "Nombre, Apellidos, Rut, Email, Genero, IdCiudad")] ApplicationUser model)
        {
            List<Ciudad> ciudades = db.Ciudad.ToList();
            ViewBag.IdCiudad = new SelectList((from p in ciudades.ToList()
                                               select new
